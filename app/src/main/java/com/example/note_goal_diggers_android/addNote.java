...
public class addNote  extends AppCompatActivity {
        ...
        uploadTask = ref.putFile(imguri)
                .addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                    ...
                    public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                        ...
                        Toast.makeText(addNote.this,"imageupload successfull",Toast.LENGTH_LONG).show();
                    }
                })
    ...
    private void uploadaudio(){
        ...
        Toast.makeText(addNote.this,"uploading audio",Toast.LENGTH_LONG).show();
        ...
        audiotask = aref.putFile(uri)
                .addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                    ...
                    public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                        ...
                        Toast.makeText(addNote.this,"audio upload successfull",Toast.LENGTH_LONG).show();
                    }
                })
                .addOnFailureListener(new OnFailureListener() {
                    @Override
