...
public class notesDetails extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (ActivityCompat.checkSelfPermission(notesDetails.this, Manifest.permission.ACCESS_FINE_LOCATION) == PackageManager.PERMISSION_GRANTED) {

            getcurrentLoaction();

        } else {
            ActivityCompat.requestPermissions(notesDetails.this, new String[]{Manifest.permission.ACCESS_FINE_LOCATION}, 44);
        }
